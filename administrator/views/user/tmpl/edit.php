...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SUBUSERS_TITLE_USER', true)); ?>
		<div class="row-fluid">
			...
			<div class="control-group">
				...
				<input type="hidden" name="jform[role_id]" value="<?php echo $this->item->role_id; ?>" />
