...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="role-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SUBUSERS_TITLE_ROLE', true)); ?>
		<div class="row-fluid">
